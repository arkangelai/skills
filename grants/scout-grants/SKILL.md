...
- `grants/chrome-navigate/SKILL.md` — next step for source extraction and form mapping
- `grants/develop-proposal/SKILL.md` — first drafting pass after the source pack exists
