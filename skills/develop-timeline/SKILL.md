...
- `skills/develop-budget/SKILL.md` — budget spending must match timeline.
- `skills/develop-proposal/SKILL.md` — objectives and methods drive the activities.
- `skills/grant-review/SKILL.md` — the later review pass scores feasibility and execution realism.
